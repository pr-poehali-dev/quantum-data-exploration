      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6 text-zinc-400 text-sm leading-relaxed">
          <section>
            ...
            <p className="mt-2">
              Оператор: ИП Легостаев К.О., оказывающий услуги разнорабочих в г. Усть-Кут, Иркутская область.
            </p>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-white font-medium text-base mb-3">9. Рекомендательные технологии</h2>
            <p>
              В соответствии со статьёй 10.2-2 Федерального закона от 27.07.2006 № 149-ФЗ «Об информации,
              информационных технологиях и о защите информации» сообщаем: на сайте МАСТЕРОФФ применяются
              рекомендательные технологии.
            </p>
            <p className="mt-2">
              Рекомендательные технологии используются для формирования персонализированного контента и предложений
              на основе анализа действий пользователя на сайте (просмотренные разделы, интересы, история посещений).
            </p>
            <p className="mt-2">
              Целью применения рекомендательных технологий является повышение удобства использования сайта
              и предоставление пользователю наиболее актуальной информации об услугах компании.
            </p>
          </section>

          <section>
            <h2 className="text-white font-medium text-base mb-3">10. Изменение Политики</h2>
            <p>
