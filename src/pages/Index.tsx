...
const Index = () => {
  ...
  return (
    <>
    <Helmet>
      <title>МАСТЕРОФФ — строительная компания в Усть-Куте</title>
      <meta name="description" content="Строительная компания МАСТЕРОФФ в Усть-Куте. Строительство домов, бань, заборов, фундаментов под ключ. Гарантия качества, доступные цены. Звоните: +7 (950) 099-09-31" />
    </Helmet>
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#09090B" }}>
      ...
      <main className="flex-1 flex items-center justify-center overflow-hidden relative">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6">
          ...
          >
            Строительная компания в Усть‑Куте
          </motion.p>
