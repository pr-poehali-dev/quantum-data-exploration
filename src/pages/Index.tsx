...
const Index = () => {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="МАСТЕРОФФ — строительная компания в Усть-Куте. Строительство домов, бань, заборов, фундаментов, а также бытовые услуги: мастер на час, грузчики, электрик, сантехник. Звоните — приедем быстро!" />
    </Helmet>
