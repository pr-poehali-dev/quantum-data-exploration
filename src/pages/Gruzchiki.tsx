  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Профессиональные грузчики в Усть-Куте. Погрузка, разгрузка, переезд, подъём на этаж. Выезд в день обращения. От 500 руб/час. Звоните: +7 (950) 099-09-31"
        />
        <meta
          name="keywords"
        ...
        <div className="w-full flex justify-center px-4 md:px-10 mb-12">
          <div className="w-full max-w-6xl grid md:grid-cols-2 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 flex flex-col gap-4">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">Помогаем жителям Усть-Кута с переездами, выносом мебели и бытовых вещей. Работаем быстро, бережно и без лишних вопросов. Приедем в удобное время.</p>
              <ul className="flex flex-col gap-2 mt-1">
                {["Квартирные и дачные переезды", "Оплата наличными или картой", "Выезд в день обращения", "Без предоплаты"].map(item => (
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 flex flex-col gap-4">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">Заключаем договор с организациями и ИП. Предоставляем закрывающие документы: акты, счета-фактуры, УПД. Подходим для офисных переездов, складских работ, строительных объектов.</p>
              <ul className="flex flex-col gap-2 mt-1">
                {["Официальный договор", "Полный пакет документов", "Работа с НДС", "Офисные и складские переезды"].map(item => (
                  <li key={item} className="flex items-center gap-2 text-zinc-300 text-sm">
                    <Icon name="Check" size={15} className="text-amber-400 shrink-0" />
                    {item}
                  </li>
