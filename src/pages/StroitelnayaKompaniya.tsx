  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#09090B" }}>
      <Helmet>
        ...
        <meta name="keywords" content="строительство домов Усть-Кут, строительная компания Усть-Кут, построить дом Усть-Кут, каркасные дома Усть-Кут, дом из бруса Усть-Кут, коттеджи Усть-Кут" />
