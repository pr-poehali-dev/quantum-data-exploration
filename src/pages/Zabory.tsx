    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#09090B" }}>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "url('https://cdn.poehali.dev/projects/15ec8a0b-bce5-45ef-9e7c-5faa77ada60e/files/ad70d08b-edd6-4333-bb83-6becc3bd58b5.jpg')",
      ...
      <section className="py-10 md:py-16 px-4 md:px-6" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            style={{ backgroundColor: "#ffffff", border: "1px solid #d5d0c5" }}
          >
