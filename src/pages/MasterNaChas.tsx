        ...
        <div className="w-full flex justify-center px-4 md:px-10 mb-12">
          <div className="w-full max-w-6xl grid md:grid-cols-2 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 flex flex-col gap-4">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">Выезжаем к жителям Усть-Кута для любых домашних задач: ремонт, сантехника, электрика, сборка мебели. Мастер приедет в удобное время и решит вопрос за один визит.</p>
              <ul className="flex flex-col gap-2 mt-1">
                {["Разовые и регулярные вызовы", "Оплата наличными или картой", "Выезд в день обращения", "Гарантия на работы"].map(item => (
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 flex flex-col gap-4">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">Заключаем договор с организациями и ИП. Предоставляем закрывающие документы. Подходим для обслуживания офисов, магазинов, производственных помещений и коммерческой недвижимости.</p>
              <ul className="flex flex-col gap-2 mt-1">
                {["Официальный договор", "Полный пакет документов", "Работа с НДС", "Обслуживание объектов по договору"].map(item => (
                  <li key={item} className="flex items-center gap-2 text-zinc-300 text-sm">
                    <Icon name="Check" size={15} className="text-amber-400 shrink-0" />
                    {item}
                  </li>
